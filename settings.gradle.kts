...
// Temporarily disabled due to missing SNAPSHOT dependencies (dataspacetck 1.0.0-SNAPSHOT)
...
// Temporarily disabled due to missing SNAPSHOT dependency (signaling-data-plane depends on dataplane-sdk 0.0.2-SNAPSHOT)
