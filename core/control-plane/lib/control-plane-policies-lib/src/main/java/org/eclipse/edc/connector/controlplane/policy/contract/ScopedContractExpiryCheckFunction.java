...
import org.eclipse.edc.connector.controlplane.contract.spi.TransferScopeContext;
 ...
 */
public class ScopedContractExpiryCheckFunction implements AtomicConstraintRuleFunction<Permission, TransferScopeContext> {
    ...
    @Override
    public boolean evaluate(Operator operator, Object rightValue, Permission rule, TransferScopeContext context) {
        ...
        try {
            ...
            if (duration != null) {
                var agreement = context.getContractAgreement();
    ...
    /**
     * Checks whether an input string fits the regex {@link ScopedContractExpiryCheckFunction#EXPRESSION_REGEX}, e.g. "contractAgreement+50m"
