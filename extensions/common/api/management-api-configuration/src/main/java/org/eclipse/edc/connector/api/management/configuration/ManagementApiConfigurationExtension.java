...
public class ManagementApiConfigurationExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        webService.registerResource(webServiceConfiguration.getContextAlias(), new JsonLdExpansionInterceptor(typeManager.getMapper(JSON_LD), jsonLdService, transformerRegistry));
    }
}
